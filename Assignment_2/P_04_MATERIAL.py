...
# Form implementation generated from reading ui file 'P_04_MATERIAL.ui'
#
...
"")
        ...
        self.label_8.setGeometry(QtCore.QRect(480, 140, 101, 41))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.lineEdit_6.setGeometry(QtCore.QRect(590, 150, 301, 111))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(12)
        font.setBold(True)
...
"border-radius:10px;")
        ...
        self.label_4.setGeometry(QtCore.QRect(480, 80, 91, 41))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.label_4.setStyleSheet("border: none;color: rgb(0, 0, 255);")
        self.label_4.setObjectName("label_4")
        self.label_9 = QtWidgets.QLabel(self.frame)
        self.label_9.setGeometry(QtCore.QRect(590, 80, 201, 41))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.label_9.setStyleSheet("border: none;color: rgb(170, 0, 127);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_2.setText(_translate("MainWindow", "Materials"))
        ...
        item.setText(_translate("MainWindow", "CD-2020"))
        item = self.tableWidget.item(0, 1)
        item.setText(_translate("MainWindow", "Name_MT"))
        item = self.tableWidget.item(0, 2)
        item.setText(_translate("MainWindow", "10223.99"))
        ...
        self.label_9.setText(_translate("MainWindow", "0001"))
        ...
        self.pushButton_9.clicked.connect(self.addStock)
        self.pushButton_10.clicked.connect(self.saveStock)
        self.pushButton_11.clicked.connect(self.deleteStock)
        self.pushButton_12.clicked.connect(self.refreshStock)
        self.tableWidget.doubleClicked.connect(self.fetchData)
    def fetchData(self):
        self.lineEdit_4.setReadOnly(True)
        ...
        if (row != -1):
                self.lineEdit_4.setText(str(self.tableWidget.item(row, 0).text()))  #MATERIAL_CODE:
                self.lineEdit_2.setText(str(self.tableWidget.item(row, 1).text()))  #MATERIAL_NAME:
                self.lineEdit_3.setText(str(self.tableWidget.item(row, 2).text())) #CURRENT_STOCK:
                self.lineEdit_6.setText(str(self.tableWidget.item(row, 3).text())) #COMMENT:
                self.label_9.setText(str(self.tableWidget.item(row, 4).text()))   #ID:

    def addStock(self):
     

        if (self.lineEdit_2.text() != "" and self.lineEdit_3.text() != "" and self.lineEdit_6.text() != "" and self.lineEdit_4.text() != ""):
                connection = sqlite3.connect("WT_P.db")
                c = connection.cursor()

                # Check if MATERIAL_CODE already exists
                material_code = self.lineEdit_4.text()
                c.execute("SELECT COUNT(*) FROM STOCK_MST WHERE MATERIAL_CODE = ?", (material_code,))
                result = c.fetchone()

                if result[0] > 0:  # If count is greater than 0, MATERIAL_CODE exists
                        self.label_7.setText("Material code already exists.")
                        ...
                        # Insert new record
                        c.execute(
                        "INSERT INTO STOCK_MST (MATERIAL_CODE, MATERIAL_NAME, CURRENT_STOCK, COMMENT) VALUES(?, ?, ?, ?)",
                        (self.lineEdit_4.text(), self.lineEdit_2.text(), self.lineEdit_3.text(), self.lineEdit_6.text())
                        )
                        connection.commit()
                        self.loadData()
                ...
                self.label_7.setText("Please fill all fields.")
                self.label_7.setStyleSheet("color: rgb(255, 0, 0);\n"
                "border: none;")
                self.label_7.show()
    ...
    def refreshStock(self):
        ...
        self.lineEdit_4.setText("")  #MATERIAL_CODE:
        self.lineEdit_2.setText("")  #MATERIAL_NAME:
        self.lineEdit_3.setText("") #CURRENT_STOCK:
        self.lineEdit_6.setText("") #COMMENT:
        connection = sqlite3.connect("WT_P.db")
        c = connection.cursor()   
        c.execute("SELECT MAX(ID) FROM STOCK_MST")
        last_id = c.fetchone()[0]
        if last_id is None:
                last_id = 0
        self.label_9.setText(str(last_id + 1))   #ID:   
    def loadData(self):
        self.pushButton_9.setDisabled(True)
        connection = sqlite3.connect("WT_P.db")
        c = connection.cursor()   
        c.execute("SELECT MATERIAL_CODE, MATERIAL_NAME, CURRENT_STOCK, COMMENT, ID FROM STOCK_MST") 
        rows =c.fetchall()
        ...
        if(self.tableWidget.rowCount() > 0):
                self.lineEdit_4.setText(str(self.tableWidget.item(0, 0).text()))  #MATERIAL_CODE:
                self.lineEdit_2.setText(str(self.tableWidget.item(0, 1).text()))  #MATERIAL_NAME:
                self.lineEdit_3.setText(str(self.tableWidget.item(0, 2).text())) #CURRENT_STOCK:
                self.lineEdit_6.setText(str(self.tableWidget.item(0, 3).text())) #COMMENT:
                self.label_9.setText(str(self.tableWidget.item(0, 4).text()))   #ID:
